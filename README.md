An Immersive Labeling Method for Large Point Clouds.（Currently we publish a test version, we will refine this repo in next weeks, thank you very much）[Project Page](https://lintianfang.github.io/Immersive_pc_labeling_webpage/)
